...
- Population: 1-bedroom appartments in Manhattan
...
**Interpretation**: We are 95% confident that the interval contains the true mean. In repeated samples, 19 of 20 intervals would catch the true value.
...
**Interpretation**: We are 95% certain that the true median price of a  1-bedroom apartment in Manhattan is between $2162 - 2875
...
(population is entire universe of cases, sample are the cases included in analysis)
...
**Interpretation**: We are 95% confident that the true proportion of mice that died while not on treatment is between 0.69 - 0.793
...
```{r practice_2_ci}
ci_mice_lived <- get_ci(boot_prop_live, level = 0.90)
ci_mice_lived
```
...
**Interpretation**: We are 90% confident that the true proportion of mice that lived while on the treatment is between 0.552 and 0.651
